...
import CardsPainting from '../../../images/Website_Photos/Cards.jpg'; 
...
function ProductItem() {
    ...
    <>  
        ...
        <div className="image-container">
            <a href={CardsPainting} target="_blank">
            <Image src={CardsPainting} className="product_image" width="600" height="400"/>
            </a>
